...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'davidiq.reimg.listener' => 'getDavidiq_Reimg_ListenerService',
    ...
    /**
     * Gets the 'davidiq.reimg.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \davidiq\reimg\event\listener A davidiq\reimg\event\listener instance.
     */
    protected function getDavidiq_Reimg_ListenerService()
    {
        return $this->services['davidiq.reimg.listener'] = new \davidiq\reimg\event\listener($this->get('config'), $this->get('template'), $this->get('user'), 'php');
    }
    ...
    protected function getDbal_Conn_DriverService()
    {
        ...
        $instance->sql_connect('localhost', 'root', 'Baron_13', 'kyivmodul_forum', '', false, false);
    ...
    protected function getDispatcherService()
    {
        ...
        $instance->addSubscriberService('davidiq.reimg.listener', 'davidiq\\reimg\\event\\listener');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'dbal.dbuser' => 'root',
            'dbal.dbpasswd' => 'Baron_13',
            'dbal.dbname' => 'kyivmodul_forum',
            'dbal.dbport' => '',
            'dbal.new_link' => false,
        );
    }
