...
/* attachment.html */
class __TwigTemplate_4a6053acd64f23d30439c528cc9dc83f5c27f20a3bfde91a9a7384441d272684 extends Twig_Template
{
...
\t\t\t<dt><a href=\"";
                    ...
                    echo "\" onclick=\"window.open(this.href); return false;\" ><img src=\"";
...
/* 		<dl class="thumbnail">*/
/* 			<dt><a href="{_file.U_DOWNLOAD_LINK}" onclick="window.open(this.href); return false;" ><img src="{_file.THUMB_IMAGE}" class="postimage" alt="{_file.DOWNLOAD_NAME}" title="{_file.DOWNLOAD_NAME} ({_file.FILESIZE} {_file.SIZE_LANG}) {_file.L_DOWNLOAD_COUNT}" /></a></dt>*/
